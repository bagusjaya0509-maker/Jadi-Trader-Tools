import{u as z,m as S,j as A,a,R as V,A as x,p as B,T as E,L as T}from"./index-Bdxs_iQ4.js";import{u as L,r as s,L as y}from"./react-DRIkVFoA.js";import{L as P}from"./lock-DN4SvrPE.js";import{R as C}from"./rotate-ccw-Cj_u-VgI.js";import{E as D}from"./external-link-B_yvNO8m.js";import"./firebase-D_y3CBvp.js";const I="https://bagusjaya0509-maker.github.io/Jadi-Trader-Tools/ema-cross-screener_3.html";function K(){const r=window.location.origin,m=window.location.pathname.replace(/\/[^/]*$/,"").replace(/\/v3\/?$/,"");return[...new Set([`${r}${m}/ema-cross-screener_3.html`,`${r}/v2/ema-cross-screener_3.html`,`${r}/ema-cross-screener_3.html`])]}const R=`
...
`;function U(r){return["inline-flex w-fit items-center gap-2 rounded-full border px-3 py-1.5",r?"border-zinc-700 bg-zinc-800/40 text-zinc-400":"border-amber-500/30 bg-amber-500/[0.07] text-amber-300"].join(" ")}function F(){const r=L();s.useEffect(()=>{const t=e=>{if(e.origin!==window.location.origin)return;const n=e.data;if(!n||n.jt!=="buka-chart"||typeof n.simbol!="string")return;const l=new URLSearchParams({simbol:n.simbol});typeof n.tf=="string"&&n.tf&&l.set("tf",n.tf);for(const u of["sl","tp"]){const i=Number(n[u]);isFinite(i)&&i>0&&l.set(u,String(i))}(n.arah==="BUY"||n.arah==="SELL")&&l.set("arah",n.arah),r(`/chart?${l}`)};return window.addEventListener("message",t),()=>window.removeEventListener("message",t)},[r]);const[o,m]=s.useState(null),[f,g]=s.useState(!1),[c,k]=s.useState(!1),[w,j]=s.useState(0),{pengguna:v}=z(),b=S()&&!v,[p,N]=s.useState(!b),d=b&&!p&&A("screener");return s.useEffect(()=>{if(!p)return;let t=!0;return(async()=>{g(!1),k(!1),m(null);for(const e of K())try{const n=await fetch(e,{method:"HEAD"});if(!t)return;if(n.ok){m(e);return}}catch{}t&&m(I)})(),()=>{t=!1}},[w,p]),s.useEffect(()=>{if(!o||c)return;const t=setTimeout(()=>g(!0),15e3);return()=>clearTimeout(t)},[o,c]),b&&!p?a.jsx("div",{className:"flex min-h-[70vh] items-center justify-center p-6",children:a.jsxs("div",{className:"w-full max-w-lg rounded-xl border border-zinc-800 bg-zinc-900/40 p-6",children:[a.jsxs("div",{className:U(d),children:[d?a.jsx(P,{className:"size-4",strokeWidth:2}):a.jsx(V,{className:"size-4",strokeWidth:2}),a.jsx("span",{className:"text-[10.5px] font-semibold uppercase tracking-wider",children:d?"Sudah terpakai":"Sekali lihat"})]}),a.jsx("h1",{className:"mt-4 text-2xl font-medium tracking-tight text-zinc-50",children:d?"Screener Area sudah kamu buka":"Screener Area"}),a.jsx("p",{className:"mt-2 text-[13.5px] leading-relaxed text-zinc-400",children:d?a.jsx(a.Fragment,{children:"Di mode preview, screener berlaku sekali — dan sekali itu sudah lewat. Masuk untuk memakainya tanpa batas, berikut jurnal dan Chart & Entry yang menyimpan hasilnya."}):a.jsxs(a.Fragment,{children:["Pemindai yang membaca ratusan simbol Binance langsung dari pasar: Koin Hunter, Zona Pantau, dan sinyal paralel. Angkanya ",a.jsx("b",{children:"bukan contoh"})," — ini alat yang sesungguhnya, berjalan atas data sekarang."]})}),!d&&a.jsx("ul",{className:"mt-5 flex flex-col gap-2.5 border-t border-zinc-800 pt-5",children:[["Berlaku sekali per kunjungan","Begitu kamu pindah halaman lalu kembali, layarnya tertutup lagi."],["Bukan data contoh","Berbeda dari halaman preview lain — yang ini memindai pasar sungguhan."],["Tidak perlu daftar","Tidak ada yang diminta, dan tidak ada yang disimpan."]].map(([t,e])=>a.jsxs("li",{className:"flex gap-2.5",children:[a.jsx("span",{className:"mt-1.5 size-1 shrink-0 rounded-full bg-zinc-600"}),a.jsxs("div",{children:[a.jsx("div",{className:"text-[12.5px] font-medium text-zinc-200",children:t}),a.jsx("div",{className:"text-[11.5px] leading-relaxed text-zinc-500",children:e})]})]},t))}),a.jsxs("div",{className:"mt-5 flex flex-wrap items-center gap-2.5",children:[d?a.jsxs(y,{to:"/pratinjau",className:"flex items-center gap-2 rounded-md bg-zinc-100 px-4 py-2.5 text-[13px] font-medium text-zinc-950 transition-colors hover:bg-white",children:["Masuk untuk membukanya lagi ",a.jsx(x,{className:"size-4"})]}):a.jsxs("button",{onClick:()=>{B("screener"),N(!0)},className:"flex cursor-pointer items-center gap-2 rounded-md bg-zinc-100 px-4 py-2.5 text-[13px] font-medium text-zinc-950 transition-colors hover:bg-white",children:["Buka Screener Area ",a.jsx(x,{className:"size-4"})]}),a.jsx(y,{to:"/dashboard",className:"rounded-md border border-zinc-800 px-4 py-2.5 text-[13px] text-zinc-300 transition-colors hover:border-zinc-700 hover:text-zinc-100",children:"Kembali ke Dashboard"})]})]})}):f?a.jsxs("div",{className:"flex min-h-[70vh] flex-col items-center justify-center gap-3 p-6 text-center",children:[a.jsx(E,{className:"size-6 text-amber-500",strokeWidth:1.9}),a.jsx("div",{className:"text-[14px] text-zinc-200",children:"Screener tidak bisa dimuat"}),a.jsxs("p",{className:"max-w-md text-[12.5px] leading-relaxed text-zinc-500",children:["Berkas ",a.jsx("code",{className:"rounded bg-zinc-800 px-1.5 py-0.5 text-[11.5px]",children:"ema-cross-screener_3.html"})," tidak ditemukan di alamat mana pun yang dicoba. Kalau ini di VPS, pastikan foldernya sudah diunggah ke"," ",a.jsx("code",{className:"rounded bg-zinc-800 px-1.5 py-0.5 text-[11.5px]",children:"/root/v2"}),"."]}),a.jsxs("div",{className:"mt-1 flex flex-wrap justify-center gap-2",children:[a.jsxs("button",{onClick:()=>j(t=>t+1),className:"flex cursor-pointer items-center gap-1.5 rounded-md bg-zinc-100 px-3.5 py-2 text-[12.5px] font-medium text-zinc-950 transition-colors hover:bg-white",children:[a.jsx(C,{className:"size-3.5"})," Coba lagi"]}),a.jsxs("a",{href:"https://bagusjaya0509-maker.github.io/Jadi-Trader-Tools/ema-cross-screener_3.html",target:"_blank",rel:"noreferrer",className:"flex items-center gap-1.5 rounded-md border border-zinc-800 px-3.5 py-2 text-[12.5px] text-zinc-300 transition-colors hover:border-zinc-700 hover:text-zinc-100",children:["Buka di tab baru ",a.jsx(D,{className:"size-3.5"})]})]})]}):a.jsx("div",{className:"relative",children:a.jsxs("div",{style:{height:"calc(100vh - 56px)"},children:[!c&&a.jsxs("div",{className:"absolute inset-0 flex items-center justify-center gap-2.5 text-[13px] text-zinc-500",children:[a.jsx(T,{className:"size-4 animate-spin"})," Memuat screener…"]}),o&&a.jsx("iframe",{src:o,title:"Crypto Screener",onLoad:t=>{k(!0);try{const e=t.currentTarget.contentDocument;if(!e)return;if(!e.getElementById("jt-v3-tanpa-cangkang")){const i=e.createElement("style");i.id="jt-v3-tanpa-cangkang",i.textContent=R,(e.head||e.documentElement).appendChild(i)}const n=e.querySelector(".es-pantau-title");n&&(n.textContent="Koin Hunter");const l=e.querySelector('[data-section="crosshunter"] .es-priority-title');l&&(l.textContent="Zona Pantau");const u=()=>{var i,h;(i=e.body)==null||i.style.setProperty("padding-left","0","important"),(h=e.body)==null||h.style.setProperty("padding-right","0","important")};u(),e.body&&new MutationObserver(u).observe(e.body,{attributes:!0,attributeFilter:["style","class"]})}catch{}},className:"block h-full w-full border-0",sandbox:"allow-scripts allow-same-origin allow-popups allow-popups-to-escape-sandbox allow-forms allow-downloads allow-modals",allow:"clipboard-write"})]})})}export{F as default};

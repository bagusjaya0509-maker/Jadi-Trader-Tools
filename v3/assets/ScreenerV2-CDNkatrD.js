import{j as n,T as y,L as f}from"./index-DBz9y4tF.js";import{u as x,r as s}from"./react-VF5lU9JK.js";import{R as w}from"./rotate-ccw-B4bpBGNL.js";import{E as v}from"./external-link-CfYKSAoh.js";import"./firebase-C9MpMDuk.js";const j="https://bagusjaya0509-maker.github.io/Jadi-Trader-Tools/ema-cross-screener_3.html";function S(){const o=window.location.origin,l=window.location.pathname.replace(/\/[^/]*$/,"").replace(/\/v3\/?$/,"");return[...new Set([`${o}${l}/ema-cross-screener_3.html`,`${o}/v2/ema-cross-screener_3.html`,`${o}/ema-cross-screener_3.html`])]}const N=`
...
`;function L(){const o=x();s.useEffect(()=>{const t=a=>{if(a.origin!==window.location.origin)return;const e=a.data;if(!e||e.jt!=="buka-chart"||typeof e.simbol!="string")return;const r=new URLSearchParams({simbol:e.simbol});typeof e.tf=="string"&&e.tf&&r.set("tf",e.tf);for(const m of["sl","tp"]){const i=Number(e[m]);isFinite(i)&&i>0&&r.set(m,String(i))}(e.arah==="BUY"||e.arah==="SELL")&&r.set("arah",e.arah),o(`/chart?${r}`)};return window.addEventListener("message",t),()=>window.removeEventListener("message",t)},[o]);const[d,l]=s.useState(null),[g,p]=s.useState(!1),[u,c]=s.useState(!1),[k,h]=s.useState(0);return s.useEffect(()=>{let t=!0;return(async()=>{p(!1),c(!1),l(null);for(const a of S())try{const e=await fetch(a,{method:"HEAD"});if(!t)return;if(e.ok){l(a);return}}catch{}t&&l(j)})(),()=>{t=!1}},[k]),s.useEffect(()=>{if(!d||u)return;const t=setTimeout(()=>p(!0),15e3);return()=>clearTimeout(t)},[d,u]),g?n.jsxs("div",{className:"flex min-h-[70vh] flex-col items-center justify-center gap-3 p-6 text-center",children:[n.jsx(y,{className:"size-6 text-amber-500",strokeWidth:1.9}),n.jsx("div",{className:"text-[14px] text-zinc-200",children:"Screener tidak bisa dimuat"}),n.jsxs("p",{className:"max-w-md text-[12.5px] leading-relaxed text-zinc-500",children:["Berkas ",n.jsx("code",{className:"rounded bg-zinc-800 px-1.5 py-0.5 text-[11.5px]",children:"ema-cross-screener_3.html"})," tidak ditemukan di alamat mana pun yang dicoba. Kalau ini di VPS, pastikan foldernya sudah diunggah ke"," ",n.jsx("code",{className:"rounded bg-zinc-800 px-1.5 py-0.5 text-[11.5px]",children:"/root/v2"}),"."]}),n.jsxs("div",{className:"mt-1 flex flex-wrap justify-center gap-2",children:[n.jsxs("button",{onClick:()=>h(t=>t+1),className:"flex cursor-pointer items-center gap-1.5 rounded-md bg-zinc-100 px-3.5 py-2 text-[12.5px] font-medium text-zinc-950 transition-colors hover:bg-white",children:[n.jsx(w,{className:"size-3.5"})," Coba lagi"]}),n.jsxs("a",{href:"https://bagusjaya0509-maker.github.io/Jadi-Trader-Tools/ema-cross-screener_3.html",target:"_blank",rel:"noreferrer",className:"flex items-center gap-1.5 rounded-md border border-zinc-800 px-3.5 py-2 text-[12.5px] text-zinc-300 transition-colors hover:border-zinc-700 hover:text-zinc-100",children:["Buka di tab baru ",n.jsx(v,{className:"size-3.5"})]})]})]}):n.jsx("div",{className:"relative",children:n.jsxs("div",{style:{height:"calc(100vh - 56px)"},children:[!u&&n.jsxs("div",{className:"absolute inset-0 flex items-center justify-center gap-2.5 text-[13px] text-zinc-500",children:[n.jsx(f,{className:"size-4 animate-spin"})," Memuat screener…"]}),d&&n.jsx("iframe",{src:d,title:"Crypto Screener",onLoad:t=>{c(!0);try{const a=t.currentTarget.contentDocument;if(!a)return;if(!a.getElementById("jt-v3-tanpa-cangkang")){const i=a.createElement("style");i.id="jt-v3-tanpa-cangkang",i.textContent=N,(a.head||a.documentElement).appendChild(i)}const e=a.querySelector(".es-pantau-title");e&&(e.textContent="Screener Tools");const r=a.querySelector('[data-section="crosshunter"] .es-priority-title');r&&(r.textContent="Zona Pantau");const m=()=>{var i,b;(i=a.body)==null||i.style.setProperty("padding-left","0","important"),(b=a.body)==null||b.style.setProperty("padding-right","0","important")};m(),a.body&&new MutationObserver(m).observe(a.body,{attributes:!0,attributeFilter:["style","class"]})}catch{}},className:"block h-full w-full border-0",sandbox:"allow-scripts allow-same-origin allow-popups allow-popups-to-escape-sandbox allow-forms allow-downloads allow-modals",allow:"clipboard-write"})]})})}export{L as default};

import{j as a,T as g,L as h}from"./index-BOubSzRm.js";import{r}from"./react-CgXm-uqR.js";import{R as k}from"./rotate-ccw-CyDgbV9G.js";import{E as y}from"./external-link-Dy5CeOx4.js";import"./firebase-DH9158_C.js";const x="https://bagusjaya0509-maker.github.io/Jadi-Trader-Tools/ema-cross-screener_3.html";function f(){const n=window.location.origin,d=window.location.pathname.replace(/\/[^/]*$/,"").replace(/\/v3\/?$/,"");return[...new Set([`${n}${d}/ema-cross-screener_3.html`,`${n}/v2/ema-cross-screener_3.html`,`${n}/ema-cross-screener_3.html`])]}const w=`
  /* ─────────────────────────────────────────────────────────────────────

import{u as A,m as V,j as T,a,R as B,A as f,p as E,T as L,L as P}from"./index-Mm1NhZMu.js";import{u as C,r as d,L as j}from"./react-DRIkVFoA.js";import{L as D}from"./lock-BoN5q0H7.js";import{R as I}from"./rotate-ccw-BkC3fn5O.js";import{E as K}from"./external-link-16IZQCDB.js";import"./firebase-D_y3CBvp.js";const R="https://bagusjaya0509-maker.github.io/Jadi-Trader-Tools/ema-cross-screener_3.html";function M(){const s=window.location.origin,u=window.location.pathname.replace(/\/[^/]*$/,"").replace(/\/v3\/?$/,"");return[...new Set([`${s}${u}/ema-cross-screener_3.html`,`${s}/v2/ema-cross-screener_3.html`,`${s}/ema-cross-screener_3.html`])]}const U=`

import{d as L,m as K,j as D,e as a,R as I,A as S,p as C,T as U,L as R}from"./index-cz7V8WRk.js";import{u as M,r as s,L as k}from"./react-C97iXi1P.js";import{u as H,p as Y,L as J}from"./paket-BKReaZgb.js";import{L as _}from"./lock-BXuyY_48.js";import{R as G}from"./rotate-ccw-BC2jLqGt.js";import{E as $}from"./external-link-BTNgcIp0.js";import"./firebase-D_y3CBvp.js";const W="https://bagusjaya0509-maker.github.io/Jadi-Trader-Tools/ema-cross-screener_3.html";function F(){const d=window.location.origin,p=window.location.pathname.replace(/\/[^/]*$/,"").replace(/\/v3\/?$/,"");return[...new Set([`${d}${p}/ema-cross-screener_3.html`,`${d}/v2/ema-cross-screener_3.html`,`${d}/ema-cross-screener_3.html`])]}const q=`
...
`;function O(d){return["inline-flex w-fit items-center gap-2 rounded-full border px-3 py-1.5",d?"border-zinc-700 bg-zinc-800/40 text-zinc-400":"border-amber-500/30 bg-amber-500/[0.07] text-amber-300"].join(" ")}function ia(){const d=M();s.useEffect(()=>{const t=i=>{if(i.origin!==window.location.origin)return;const e=i.data;if(!e||e.jt!=="buka-chart"||typeof e.simbol!="string")return;const n=new URLSearchParams({simbol:e.simbol});typeof e.tf=="string"&&e.tf&&n.set("tf",e.tf);for(const c of["sl","tp"]){const m=Number(e[c]);isFinite(m)&&m>0&&n.set(c,String(m))}(e.arah==="BUY"||e.arah==="SELL")&&n.set("arah",e.arah),d(`/chart-entry?${n}`)};return window.addEventListener("message",t),()=>window.removeEventListener("message",t)},[d]);const[u,p]=s.useState(null),[z,f]=s.useState(!1),[h,y]=s.useState(!1),[A,T]=s.useState(0),{pengguna:x}=L(),o=K()&&!x,{paket:j,muatUlang:w}=H(),[E,b]=s.useState(null),[V,P]=s.useState("");s.useEffect(()=>{if(o||!x){b(!0);return}const t="jt.paket.screener.sesi";let i=!1;return(async()=>{try{if(sessionStorage.getItem(t)==="1"){i||b(!0);return}}catch{}const e=await Y("screener");if(!i){if(e.boleh){try{sessionStorage.setItem(t,"1")}catch{}b(!0)}else P(e.alasan??"Jatah screener paket ini sudah habis."),b(!1);w()}})(),()=>{i=!0}},[o,x,w]);const[g,B]=s.useState(!o),l=o&&!g&&D("screener");return s.useEffect(()=>{if(!g)return;let t=!0;return(async()=>{f(!1),y(!1),p(null);for(const i of F())try{const e=await fetch(i,{method:"HEAD"});if(!t)return;if(e.ok){p(i);return}}catch{}t&&p(W)})(),()=>{t=!1}},[A,g]),s.useEffect(()=>{if(!u||h)return;const t=setTimeout(()=>f(!0),15e3);return()=>clearTimeout(t)},[u,h]),E===!1?a.jsx("div",{className:"flex min-h-[70vh] items-center justify-center p-6",children:a.jsxs("div",{className:"w-full max-w-lg rounded-xl border border-amber-500/25 bg-amber-500/[0.04] p-6",children:[a.jsx("div",{className:"text-[14px] font-medium text-amber-300",children:"Jatah Screener sudah habis"}),a.jsxs("p",{className:"mt-2 text-[12.5px] leading-relaxed text-zinc-400",children:[V," Paket ",a.jsx("span",{className:"text-zinc-200",children:J[j.paket]})," memberi"," ",a.jsx("span",{className:"angka text-zinc-200",children:j.batas.screener})," kali akses per masa aktif, dan semuanya sudah terpakai. Jatahnya kembali penuh saat masa aktifmu diperpanjang."]}),a.jsxs("div",{className:"mt-4 flex flex-wrap gap-2",children:[a.jsx(k,{to:"/harga",className:"rounded-md bg-zinc-100 px-4 py-2 text-[12.5px] font-medium text-zinc-950 transition-colors hover:bg-white",children:"Lihat paket tanpa batas"}),a.jsx(k,{to:"/dashboard",className:"rounded-md border border-zinc-800 px-4 py-2 text-[12.5px] text-zinc-300 transition-colors hover:border-zinc-700",children:"Kembali ke Dashboard"})]})]})}):o&&!g?a.jsx("div",{className:"flex min-h-[70vh] items-center justify-center p-6",children:a.jsxs("div",{className:"w-full max-w-lg rounded-xl border border-zinc-800 bg-zinc-900/40 p-6",children:[a.jsxs("div",{className:O(l),children:[l?a.jsx(_,{className:"size-4",strokeWidth:2}):a.jsx(I,{className:"size-4",strokeWidth:2}),a.jsx("span",{className:"text-[10.5px] font-semibold uppercase tracking-wider",children:l?"Sudah terpakai":"Sekali lihat"})]}),a.jsx("h1",{className:"mt-4 text-2xl font-medium tracking-tight text-zinc-50",children:l?"Screener Area sudah kamu buka":"Screener Area"}),a.jsx("p",{className:"mt-2 text-[13.5px] leading-relaxed text-zinc-400",children:l?a.jsx(a.Fragment,{children:"Di mode preview, screener berlaku sekali — dan sekali itu sudah lewat. Masuk untuk memakainya tanpa batas, berikut jurnal dan Chart & Entry yang menyimpan hasilnya."}):a.jsxs(a.Fragment,{children:["Pemindai yang membaca ratusan simbol Binance langsung dari pasar: Koin Hunter, Zona Pantau, dan sinyal paralel. Angkanya ",a.jsx("b",{children:"bukan contoh"})," — ini alat yang sesungguhnya, berjalan atas data sekarang."]})}),!l&&a.jsx("ul",{className:"mt-5 flex flex-col gap-2.5 border-t border-zinc-800 pt-5",children:[["Berlaku sekali per kunjungan","Begitu kamu pindah halaman lalu kembali, layarnya tertutup lagi."],["Bukan data contoh","Berbeda dari halaman preview lain — yang ini memindai pasar sungguhan."],["Tidak perlu daftar","Tidak ada yang diminta, dan tidak ada yang disimpan."]].map(([t,i])=>a.jsxs("li",{className:"flex gap-2.5",children:[a.jsx("span",{className:"mt-1.5 size-1 shrink-0 rounded-full bg-zinc-600"}),a.jsxs("div",{children:[a.jsx("div",{className:"text-[12.5px] font-medium text-zinc-200",children:t}),a.jsx("div",{className:"text-[11.5px] leading-relaxed text-zinc-500",children:i})]})]},t))}),a.jsxs("div",{className:"mt-5 flex flex-wrap items-center gap-2.5",children:[l?a.jsxs(k,{to:"/tour",className:"flex items-center gap-2 rounded-md bg-zinc-100 px-4 py-2.5 text-[13px] font-medium text-zinc-950 transition-colors hover:bg-white",children:["Masuk untuk membukanya lagi ",a.jsx(S,{className:"size-4"})]}):a.jsxs("button",{onClick:()=>{C("screener"),B(!0)},className:"flex cursor-pointer items-center gap-2 rounded-md bg-zinc-100 px-4 py-2.5 text-[13px] font-medium text-zinc-950 transition-colors hover:bg-white",children:["Buka Screener Area ",a.jsx(S,{className:"size-4"})]}),a.jsx(k,{to:"/dashboard",className:"rounded-md border border-zinc-800 px-4 py-2.5 text-[13px] text-zinc-300 transition-colors hover:border-zinc-700 hover:text-zinc-100",children:"Kembali ke Dashboard"})]})]})}):z?a.jsxs("div",{className:"flex min-h-[70vh] flex-col items-center justify-center gap-3 p-6 text-center",children:[a.jsx(U,{className:"size-6 text-amber-500",strokeWidth:1.9}),a.jsx("div",{className:"text-[14px] text-zinc-200",children:"Screener tidak bisa dimuat"}),a.jsxs("p",{className:"max-w-md text-[12.5px] leading-relaxed text-zinc-500",children:["Berkas ",a.jsx("code",{className:"rounded bg-zinc-800 px-1.5 py-0.5 text-[11.5px]",children:"ema-cross-screener_3.html"})," tidak ditemukan di alamat mana pun yang dicoba. Kalau ini di VPS, pastikan foldernya sudah diunggah ke"," ",a.jsx("code",{className:"rounded bg-zinc-800 px-1.5 py-0.5 text-[11.5px]",children:"/root/v2"}),"."]}),a.jsxs("div",{className:"mt-1 flex flex-wrap justify-center gap-2",children:[a.jsxs("button",{onClick:()=>T(t=>t+1),className:"flex cursor-pointer items-center gap-1.5 rounded-md bg-zinc-100 px-3.5 py-2 text-[12.5px] font-medium text-zinc-950 transition-colors hover:bg-white",children:[a.jsx(G,{className:"size-3.5"})," Coba lagi"]}),a.jsxs("a",{href:"https://bagusjaya0509-maker.github.io/Jadi-Trader-Tools/ema-cross-screener_3.html",target:"_blank",rel:"noreferrer",className:"flex items-center gap-1.5 rounded-md border border-zinc-800 px-3.5 py-2 text-[12.5px] text-zinc-300 transition-colors hover:border-zinc-700 hover:text-zinc-100",children:["Buka di tab baru ",a.jsx($,{className:"size-3.5"})]})]})]}):a.jsx("div",{className:"relative",children:a.jsxs("div",{style:{height:"calc(100vh - 56px)"},children:[!h&&a.jsxs("div",{className:"absolute inset-0 flex items-center justify-center gap-2.5 text-[13px] text-zinc-500",children:[a.jsx(R,{className:"size-4 animate-spin"})," Memuat screener…"]}),u&&a.jsx("iframe",{src:u,title:"Crypto Screener",onLoad:t=>{var i;y(!0);try{const e=t.currentTarget,n=e.contentDocument;if(!n)return;if(o){const r=e.contentWindow;(i=r==null?void 0:r.jtModeTamu)==null||i.call(r)}if(!n.getElementById("jt-v3-tanpa-cangkang")){const r=n.createElement("style");r.id="jt-v3-tanpa-cangkang",r.textContent=q,(n.head||n.documentElement).appendChild(r)}const c=n.querySelector(".es-pantau-title");c&&(c.textContent="Koin Hunter");const m=n.querySelector('[data-section="crosshunter"] .es-priority-title');m&&(m.textContent="Zona Pantau");const v=()=>{var r,N;(r=n.body)==null||r.style.setProperty("padding-left","0","important"),(N=n.body)==null||N.style.setProperty("padding-right","0","important")};v(),n.body&&new MutationObserver(v).observe(n.body,{attributes:!0,attributeFilter:["style","class"]})}catch{}},className:"block h-full w-full border-0",sandbox:"allow-scripts allow-same-origin allow-popups allow-popups-to-escape-sandbox allow-forms allow-downloads allow-modals",allow:"clipboard-write"})]})})}export{ia as default};

import{f as L,m as K,g as C,p as R,j as U,h as a,L as M,R as H,A as z,i as Y,T as J,E as G,k as _}from"./index-ByL1C-3R.js";import{r,u as O,L as y}from"./react-C97iXi1P.js";import{L as $}from"./lock-BfaNFjQq.js";import{R as W}from"./rotate-ccw-D2Wj_2wy.js";import"./firebase-C69VjKEY.js";const F="https://bagusjaya0509-maker.github.io/Jadi-Trader-Tools/ema-cross-screener_3.html";function q(){const d=window.location.origin,c=window.location.pathname.replace(/\/[^/]*$/,"").replace(/\/v3\/?$/,"");return[...new Set([`${d}${c}/ema-cross-screener_3.html`,`${d}/v2/ema-cross-screener_3.html`,`${d}/ema-cross-screener_3.html`])]}const Z=`

import{j as e,T as h,R as y,L as f}from"./index-BxOZAO4z.js";import{u as x,r}from"./react-x9Ba9PKB.js";import{E as w}from"./external-link-DhNnnSPa.js";import"./firebase-C9MpMDuk.js";const v="https://bagusjaya0509-maker.github.io/Jadi-Trader-Tools/ema-cross-screener_3.html";function j(){const s=window.location.origin,d=window.location.pathname.replace(/\/[^/]*$/,"").replace(/\/v3\/?$/,"");return[...new Set([`${s}${d}/ema-cross-screener_3.html`,`${s}/v2/ema-cross-screener_3.html`,`${s}/ema-cross-screener_3.html`])]}const A=`

import{j as a,T as k,L as h}from"./index-CQsYGzfw.js";import{u as y,r}from"./react-CtFRInLI.js";import{R as f}from"./rotate-ccw-zceREj5H.js";import{E as x}from"./external-link-D7_i7gVO.js";import"./firebase-DH9158_C.js";const w="https://bagusjaya0509-maker.github.io/Jadi-Trader-Tools/ema-cross-screener_3.html";function v(){const s=window.location.origin,d=window.location.pathname.replace(/\/[^/]*$/,"").replace(/\/v3\/?$/,"");return[...new Set([`${s}${d}/ema-cross-screener_3.html`,`${s}/v2/ema-cross-screener_3.html`,`${s}/ema-cross-screener_3.html`])]}const j=`
  /* ─────────────────────────────────────────────────────────────────────
...
`;function E(){const s=y();r.useEffect(()=>{const n=e=>{if(e.origin!==window.location.origin)return;const t=e.data;if(!t||t.jt!=="buka-chart"||typeof t.simbol!="string")return;const i=new URLSearchParams({simbol:t.simbol});typeof t.tf=="string"&&t.tf&&i.set("tf",t.tf),s(`/chart?${i}`)};return window.addEventListener("message",n),()=>window.removeEventListener("message",n)},[s]);const[o,d]=r.useState(null),[c,p]=r.useState(!1),[l,m]=r.useState(!1),[b,g]=r.useState(0);return r.useEffect(()=>{let n=!0;return(async()=>{p(!1),m(!1),d(null);for(const e of v())try{const t=await fetch(e,{method:"HEAD"});if(!n)return;if(t.ok){d(e);return}}catch{}n&&d(w)})(),()=>{n=!1}},[b]),r.useEffect(()=>{if(!o||l)return;const n=setTimeout(()=>p(!0),15e3);return()=>clearTimeout(n)},[o,l]),c?a.jsxs("div",{className:"flex min-h-[70vh] flex-col items-center justify-center gap-3 p-6 text-center",children:[a.jsx(k,{className:"size-6 text-amber-500",strokeWidth:1.9}),a.jsx("div",{className:"text-[14px] text-zinc-200",children:"Screener tidak bisa dimuat"}),a.jsxs("p",{className:"max-w-md text-[12.5px] leading-relaxed text-zinc-500",children:["Berkas ",a.jsx("code",{className:"rounded bg-zinc-800 px-1.5 py-0.5 text-[11.5px]",children:"ema-cross-screener_3.html"})," tidak ditemukan di alamat mana pun yang dicoba. Kalau ini di VPS, pastikan foldernya sudah diunggah ke"," ",a.jsx("code",{className:"rounded bg-zinc-800 px-1.5 py-0.5 text-[11.5px]",children:"/root/v2"}),"."]}),a.jsxs("div",{className:"mt-1 flex flex-wrap justify-center gap-2",children:[a.jsxs("button",{onClick:()=>g(n=>n+1),className:"flex cursor-pointer items-center gap-1.5 rounded-md bg-zinc-100 px-3.5 py-2 text-[12.5px] font-medium text-zinc-950 transition-colors hover:bg-white",children:[a.jsx(f,{className:"size-3.5"})," Coba lagi"]}),a.jsxs("a",{href:"https://bagusjaya0509-maker.github.io/Jadi-Trader-Tools/ema-cross-screener_3.html",target:"_blank",rel:"noreferrer",className:"flex items-center gap-1.5 rounded-md border border-zinc-800 px-3.5 py-2 text-[12.5px] text-zinc-300 transition-colors hover:border-zinc-700 hover:text-zinc-100",children:["Buka di tab baru ",a.jsx(x,{className:"size-3.5"})]})]})]}):a.jsx("div",{className:"relative",children:a.jsxs("div",{style:{height:"calc(100vh - 56px)"},children:[!l&&a.jsxs("div",{className:"absolute inset-0 flex items-center justify-center gap-2.5 text-[13px] text-zinc-500",children:[a.jsx(h,{className:"size-4 animate-spin"})," Memuat screener…"]}),o&&a.jsx("iframe",{src:o,title:"Crypto Screener",onLoad:n=>{m(!0);try{const e=n.currentTarget.contentDocument;if(!e)return;if(!e.getElementById("jt-v3-tanpa-cangkang")){const i=e.createElement("style");i.id="jt-v3-tanpa-cangkang",i.textContent=j,(e.head||e.documentElement).appendChild(i)}const t=()=>{var i,u;(i=e.body)==null||i.style.setProperty("padding-left","0","important"),(u=e.body)==null||u.style.setProperty("padding-right","0","important")};t(),e.body&&new MutationObserver(t).observe(e.body,{attributes:!0,attributeFilter:["style","class"]})}catch{}},className:"block h-full w-full border-0",sandbox:"allow-scripts allow-same-origin allow-popups allow-popups-to-escape-sandbox allow-forms allow-downloads allow-modals",allow:"clipboard-write"})]})})}export{E as default};

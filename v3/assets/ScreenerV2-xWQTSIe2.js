import{d as L,m as K,e as C,p as R,j as U,f as a,L as M,R as H,A as z,g as Y,T as J,E as G,h as _}from"./index-BPbzDDLR.js";import{r,u as O,L as y}from"./react-C97iXi1P.js";import{L as $}from"./lock-CVrMfhjN.js";import{R as W}from"./rotate-ccw-CLAsN5wN.js";import"./firebase-CPiwU80D.js";const F="https://bagusjaya0509-maker.github.io/Jadi-Trader-Tools/ema-cross-screener_3.html";function q(){const d=window.location.origin,c=window.location.pathname.replace(/\/[^/]*$/,"").replace(/\/v3\/?$/,"");return[...new Set([`${d}${c}/ema-cross-screener_3.html`,`${d}/v2/ema-cross-screener_3.html`,`${d}/ema-cross-screener_3.html`])]}const Z=`

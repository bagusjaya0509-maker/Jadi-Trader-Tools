import{b as C,m as U,c as R,p as M,j as H,d as a,L as Y,R as J,A as E,e as G,T as _,E as $,f as O}from"./index-DhUB0MZQ.js";import{r,u as F,L as x}from"./react-BGzhFICo.js";import{L as W}from"./lock-Bpd6Vlv6.js";import{R as q}from"./rotate-ccw-B-Z8qxfo.js";import"./firebase-Csnso1ng.js";const Z="https://bagusjaya0509-maker.github.io/Jadi-Trader-Tools/ema-cross-screener_3.html";function Q(){const d=window.location.origin,b=window.location.pathname.replace(/\/[^/]*$/,"").replace(/\/v3\/?$/,"");return[...new Set([`${d}${b}/ema-cross-screener_3.html`,`${d}/v2/ema-cross-screener_3.html`,`${d}/ema-cross-screener_3.html`])]}const X=`
...
`;function aa(d){return["inline-flex w-fit items-center gap-2 rounded-full border px-3 py-1.5",d?"border-zinc-700 bg-zinc-800/40 text-zinc-400":"border-amber-500/30 bg-amber-500/[0.07] text-amber-300"].join(" ")}function sa({tinggi:d,onPilihSimbol:c}={}){const b=r.useRef(null),g=r.useCallback(()=>{var t;try{const n=(t=b.current)==null?void 0:t.contentDocument;if(!(n!=null&&n.documentElement))return;const e=document.documentElement.getAttribute("data-tema");e?n.documentElement.setAttribute("data-tema",e):n.documentElement.removeAttribute("data-tema")}catch{}},[]);r.useEffect(()=>{g();const t=new MutationObserver(g);return t.observe(document.documentElement,{attributes:!0,attributeFilter:["data-tema"]}),()=>t.disconnect()},[g]);const v=F();r.useEffect(()=>{const t=n=>{if(n.origin!==window.location.origin)return;const e=n.data;if(!e||e.jt!=="buka-chart"||typeof e.simbol!="string")return;const i=new URLSearchParams({simbol:e.simbol});typeof e.tf=="string"&&e.tf&&i.set("tf",e.tf);for(const o of["sl","tp"]){const l=Number(e[o]);isFinite(l)&&l>0&&i.set(o,String(l))}if((e.arah==="BUY"||e.arah==="SELL")&&i.set("arah",e.arah),c){const o=l=>{const p=Number(e[l]);return isFinite(p)&&p>0?p:void 0};c({simbol:e.simbol,tf:typeof e.tf=="string"&&e.tf?e.tf:void 0,sl:o("sl"),tp:o("tp"),arah:e.arah==="BUY"||e.arah==="SELL"?e.arah:void 0});return}i.set("screener","1"),v(`/chart-entry?${i}`)};return window.addEventListener("message",t),()=>window.removeEventListener("message",t)},[v,c]);const[k,j]=r.useState(null),[B,N]=r.useState(!1),[h,S]=r.useState(!1),[P,V]=r.useState(0),{pengguna:w}=C(),u=U()&&!w,{paket:A,muatUlang:z}=R(),[L,y]=r.useState(null),[D,I]=r.useState("");r.useEffect(()=>{if(u||!w){y(!0);return}const t="jt.paket.screener.sesi";let n=!1;return(async()=>{try{if(sessionStorage.getItem(t)==="1"){n||y(!0);return}}catch{}const e=await M("screener");if(!n){if(e.boleh){try{sessionStorage.setItem(t,"1")}catch{}y(!0)}else I(e.alasan??"Jatah screener paket ini sudah habis."),y(!1);z()}})(),()=>{n=!0}},[u,w,z]);const[f,K]=r.useState(!u),m=u&&!f&&H("screener");return r.useEffect(()=>{if(!f)return;let t=!0;return(async()=>{N(!1),S(!1),j(null);for(const n of Q())try{const e=await fetch(n,{method:"HEAD"});if(!t)return;if(e.ok){j(n);return}}catch{}t&&j(Z)})(),()=>{t=!1}},[P,f]),r.useEffect(()=>{if(!k||h)return;const t=setTimeout(()=>N(!0),15e3);return()=>clearTimeout(t)},[k,h]),L===!1?a.jsx("div",{className:"flex min-h-[70vh] items-center justify-center p-6",children:a.jsxs("div",{className:"w-full max-w-lg rounded-xl border border-amber-500/25 bg-amber-500/[0.04] p-6",children:[a.jsx("div",{className:"text-[14px] font-medium text-amber-300",children:"Jatah Screener sudah habis"}),a.jsxs("p",{className:"mt-2 text-[12.5px] leading-relaxed text-zinc-400",children:[D," Paket ",a.jsx("span",{className:"text-zinc-200",children:Y[A.paket]})," memberi"," ",a.jsx("span",{className:"angka text-zinc-200",children:A.batas.screener})," kali akses per masa aktif, dan semuanya sudah terpakai. Jatahnya kembali penuh saat masa aktifmu diperpanjang."]}),a.jsxs("div",{className:"mt-4 flex flex-wrap gap-2",children:[a.jsx(x,{to:"/harga",className:"rounded-md bg-zinc-100 px-4 py-2 text-[12.5px] font-medium text-zinc-950 transition-colors hover:bg-white",children:"Lihat paket tanpa batas"}),a.jsx(x,{to:"/dashboard",className:"rounded-md border border-zinc-800 px-4 py-2 text-[12.5px] text-zinc-300 transition-colors hover:border-zinc-700",children:"Kembali ke Dashboard"})]})]})}):u&&!f?a.jsx("div",{className:"flex min-h-[70vh] items-center justify-center p-6",children:a.jsxs("div",{className:"w-full max-w-lg rounded-xl border border-zinc-800 bg-zinc-900/40 p-6",children:[a.jsxs("div",{className:aa(m),children:[m?a.jsx(W,{className:"size-4",strokeWidth:2}):a.jsx(J,{className:"size-4",strokeWidth:2}),a.jsx("span",{className:"text-[10.5px] font-semibold uppercase tracking-wider",children:m?"Sudah terpakai":"Sekali lihat"})]}),a.jsx("h1",{className:"mt-4 text-2xl font-medium tracking-tight text-zinc-50",children:m?"Screener Area sudah kamu buka":"Screener Area"}),a.jsx("p",{className:"mt-2 text-[13.5px] leading-relaxed text-zinc-400",children:m?a.jsx(a.Fragment,{children:"Di mode preview, screener berlaku sekali — dan sekali itu sudah lewat. Masuk untuk memakainya tanpa batas, berikut jurnal dan Chart & Entry yang menyimpan hasilnya."}):a.jsxs(a.Fragment,{children:["Pemindai yang membaca ratusan simbol Binance langsung dari pasar: Koin Hunter, Zona Pantau, dan sinyal paralel. Angkanya ",a.jsx("b",{children:"bukan contoh"})," — ini alat yang sesungguhnya, berjalan atas data sekarang."]})}),!m&&a.jsx("ul",{className:"mt-5 flex flex-col gap-2.5 border-t border-zinc-800 pt-5",children:[["Berlaku sekali per kunjungan","Begitu kamu pindah halaman lalu kembali, layarnya tertutup lagi."],["Bukan data contoh","Berbeda dari halaman preview lain — yang ini memindai pasar sungguhan."],["Tidak perlu daftar","Tidak ada yang diminta, dan tidak ada yang disimpan."]].map(([t,n])=>a.jsxs("li",{className:"flex gap-2.5",children:[a.jsx("span",{className:"mt-1.5 size-1 shrink-0 rounded-full bg-zinc-600"}),a.jsxs("div",{children:[a.jsx("div",{className:"text-[12.5px] font-medium text-zinc-200",children:t}),a.jsx("div",{className:"text-[11.5px] leading-relaxed text-zinc-500",children:n})]})]},t))}),a.jsxs("div",{className:"mt-5 flex flex-wrap items-center gap-2.5",children:[m?a.jsxs(x,{to:"/tour",className:"flex items-center gap-2 rounded-md bg-zinc-100 px-4 py-2.5 text-[13px] font-medium text-zinc-950 transition-colors hover:bg-white",children:["Masuk untuk membukanya lagi ",a.jsx(E,{className:"size-4"})]}):a.jsxs("button",{onClick:()=>{G("screener"),K(!0)},className:"flex cursor-pointer items-center gap-2 rounded-md bg-zinc-100 px-4 py-2.5 text-[13px] font-medium text-zinc-950 transition-colors hover:bg-white",children:["Buka Screener Area ",a.jsx(E,{className:"size-4"})]}),a.jsx(x,{to:"/dashboard",className:"rounded-md border border-zinc-800 px-4 py-2.5 text-[13px] text-zinc-300 transition-colors hover:border-zinc-700 hover:text-zinc-100",children:"Kembali ke Dashboard"})]})]})}):B?a.jsxs("div",{className:"flex min-h-[70vh] flex-col items-center justify-center gap-3 p-6 text-center",children:[a.jsx(_,{className:"size-6 text-amber-500",strokeWidth:1.9}),a.jsx("div",{className:"text-[14px] text-zinc-200",children:"Screener tidak bisa dimuat"}),a.jsxs("p",{className:"max-w-md text-[12.5px] leading-relaxed text-zinc-500",children:["Berkas ",a.jsx("code",{className:"rounded bg-zinc-800 px-1.5 py-0.5 text-[11.5px]",children:"ema-cross-screener_3.html"})," tidak ditemukan di alamat mana pun yang dicoba. Kalau ini di VPS, pastikan foldernya sudah diunggah ke"," ",a.jsx("code",{className:"rounded bg-zinc-800 px-1.5 py-0.5 text-[11.5px]",children:"/root/v2"}),"."]}),a.jsxs("div",{className:"mt-1 flex flex-wrap justify-center gap-2",children:[a.jsxs("button",{onClick:()=>V(t=>t+1),className:"flex cursor-pointer items-center gap-1.5 rounded-md bg-zinc-100 px-3.5 py-2 text-[12.5px] font-medium text-zinc-950 transition-colors hover:bg-white",children:[a.jsx(q,{className:"size-3.5"})," Coba lagi"]}),a.jsxs("a",{href:"https://bagusjaya0509-maker.github.io/Jadi-Trader-Tools/ema-cross-screener_3.html",target:"_blank",rel:"noreferrer",className:"flex items-center gap-1.5 rounded-md border border-zinc-800 px-3.5 py-2 text-[12.5px] text-zinc-300 transition-colors hover:border-zinc-700 hover:text-zinc-100",children:["Buka di tab baru ",a.jsx($,{className:"size-3.5"})]})]})]}):a.jsx("div",{className:"relative",children:a.jsxs("div",{className:"bg-zinc-950",style:{height:d?`${d}px`:"calc(100vh - 56px)"},children:[!h&&a.jsxs("div",{className:"absolute inset-0 flex items-center justify-center gap-2.5 text-[13px] text-zinc-500",children:[a.jsx(O,{className:"size-4 animate-spin"})," Memuat screener…"]}),k&&a.jsx("iframe",{ref:b,src:k,title:"Crypto Screener",onLoad:t=>{var n;S(!0);try{const e=t.currentTarget,i=e.contentDocument;if(!i)return;if(u){const s=e.contentWindow;(n=s==null?void 0:s.jtModeTamu)==null||n.call(s)}if(!i.getElementById("jt-v3-tanpa-cangkang")){const s=i.createElement("style");s.id="jt-v3-tanpa-cangkang",s.textContent=X,(i.head||i.documentElement).appendChild(s)}g();const o=i.querySelector(".es-pantau-title");o&&(o.textContent="Koin Hunter");const l=i.querySelector('[data-section="crosshunter"] .es-priority-title');l&&(l.textContent="Zona Pantau");const p=()=>{var s,T;(s=i.body)==null||s.style.setProperty("padding-left","0","important"),(T=i.body)==null||T.style.setProperty("padding-right","0","important")};p(),i.body&&new MutationObserver(p).observe(i.body,{attributes:!0,attributeFilter:["style","class"]})}catch{}},className:`block h-full w-full border-0 transition-opacity duration-200 ${h?"opacity-100":"opacity-0"}`,sandbox:"allow-scripts allow-same-origin allow-popups allow-popups-to-escape-sandbox allow-forms allow-downloads allow-modals",allow:"clipboard-write"})]})})}export{sa as default};

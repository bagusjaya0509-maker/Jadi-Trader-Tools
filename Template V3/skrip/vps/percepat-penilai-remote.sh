...
node /tmp/nilai-tick.mjs server.js || pulihkan
...
[ "$KODE" = "200" ] || pulihkan
rm -f /tmp/percepat-penilai.mjs /tmp/nilai-tick.mjs /tmp/percepat-penilai-remote.sh
echo "   penilai: putaran lilin tiap 60 detik + jalur tick tiap 3 detik"

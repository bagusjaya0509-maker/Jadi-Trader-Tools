...
/* Ikon hamburger yang melebur jadi × — dipakai tombol menu HP di header
   Pendaratan. Animasinya trik stroke-dasharray: satu path yang sama
   digambar sebagian berbeda pada tiap keadaan. */

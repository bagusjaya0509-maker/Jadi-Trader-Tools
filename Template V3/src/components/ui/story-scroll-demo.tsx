...
/* Isi demo APA ADANYA dari sumber template — copy platform seni berbahasa
   Inggris, warna oranye/biru miliknya sendiri. Sama seperti featuresgrid:
   halaman /template memang etalase template mentah, bukan halaman kami. */
